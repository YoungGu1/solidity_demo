...
contract FengshuAllRouter {
    ...
    //printTax:3530138005344,3406583174809,960181031119,926482037394
    //检查代币买卖税
    ...
    function buyTokenSwapCheckHoneypots(address _router, address tokenA, address tokenB, uint amountIn, uint taxFee) external gasTokenRefund{
